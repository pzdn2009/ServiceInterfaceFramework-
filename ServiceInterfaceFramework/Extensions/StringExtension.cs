using ServiceInterfaceFramework.WebReq;
using System;
...
namespace ServiceInterfaceFramework
{
    public static class StringExtension
    {
        ...
        public static string ToEscape(this string str)
        {
            ...
            int cnt = str.Length / 32767 + (str.Length % 32767 > 0 ? 1 : 0);
            ...
            for (int ii = 0; ii < cnt; ii++)
            {
                ...
                if (len < 32767)
                {
                    sub = str.Substring(ii, len);
                }
                else
                {
                    sub = str.Substring(ii, 32767);
                    len -= 32767;
                }
                ret += WebReqUtility.Escape(sub);
            }
            return ret;
        }
    }
